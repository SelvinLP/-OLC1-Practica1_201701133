 ...
 * @author Aragon Perez
 */
public class F_ReporteHTML extends javax.swing.JFrame {

    /**
     * Creates new form Formulario_ReporteHash
     */

    public F_ReporteHTML(String Cadena) {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(F_ReporteHTML.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new F_ReporteHTML().setVisible(true);
            }
        });
    }
